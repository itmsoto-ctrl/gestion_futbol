...
const FutCard = ({ player, size = "large" }) => {
  ...
  return (
    <motion.div className={`relative inline-block ${scales[size]} rounded-[50px] overflow-hidden shadow-2xl transition-all duration-700`}>
      ...
      {/* TEXTOS PRINCIPALES */}
      <div className="absolute top-[68px] left-[60px] z-20 text-zinc-800 text-7xl font-black italic tracking-tighter select-none">{rating}</div>
      <div className="absolute top-[140px] left-[80px] z-20 text-zinc-800 text-2xl font-bold uppercase select-none">{player.position || 'DEL'}</div>
      ...
      {/* STATS IZQUIERDA */}
      <div className="absolute top-[340px] left-[58px] z-20 text-left leading-[35px] select-none">
      ...
      {/* STATS DERECHA */}
      <div className="absolute top-[340px] left-[192px] z-20 text-left leading-[35px] select-none">
