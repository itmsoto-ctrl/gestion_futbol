...
const PlayerRegistration = () => {
    ...
    return (
        <div className="min-h-screen bg-[#665C5A] text-white p-6 flex flex-col items-center font-sans overflow-x-hidden">
            ...
            {/* LOGO ELITE */}
            <div className="mt-4 mb-6 relative logo-wrapper-elite">
                <div className="shine-layer"></div>
                <img src={logoUrl} alt="VORA" className="logo-main-elite" />
            </div>

            {/* HEADER DINÁMICO */}
            {teamInfo && step < 4 && (
                <div className="w-full max-w-sm mb-8 text-center animate-in fade-in">
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-lime-400 mb-1">
                        {step === 1 && "Bienvenido"}
            ...
            <div className="w-full max-w-sm">
                ...
                {step === 1 && (
                    <form onSubmit={handleCheckEmail} className="space-y-6 animate-in fade-in">
                        ...
                        <button type="submit" className="w-full bg-lime-400 text-zinc-950 font-black py-5 rounded-[2.5rem] flex items-center justify-center gap-4 uppercase italic text-xl active:scale-95 shadow-xl">
                ...
                {step === 2 && (
                    <form onSubmit={handleNextStep} className="space-y-4 animate-in slide-in-from-right">
                        {!userExists && (
                            <div className="relative">
                        ...
                        <button className="w-full bg-white text-black font-black py-5 rounded-[2.5rem] mt-4 italic uppercase text-lg active:scale-95">
                            SIGUIENTE
                        </button>
                    </form>
                )}
                ...
                {step === 3 && (
                    <form onSubmit={handleNextStep} className="space-y-4 animate-in slide-in-from-right">
                        <div className="bg-white/5 p-6 rounded-[2rem] border border-white/10 mb-4 text-center">
                            ...
                            <p className="text-xs font-bold text-white/60 uppercase">Información para la liga</p>
                        </div>
                        <div className="relative">
                        ...
                        <button className="w-full bg-lime-400 text-zinc-950 font-black py-5 rounded-[2.5rem] mt-4 italic uppercase text-lg active:scale-95">
                            CONFIRMAR DATOS
                        </button>
                    </form>
                )}
                            ...
                            <div className="bg-zinc-950 w-full h-full rounded-[2.3rem] overflow-hidden relative border border-lime-400/30">
                                {photoUrl ? (
                                    ...
                                    <div {...getRootProps()} className="flex flex-col items-center cursor-pointer h-full justify-center">
                                        ...
                                        <p className="text-[10px] font-black uppercase text-white leading-tight italic text-center">TOCA PARA <br/> TU FOTO DE FICHA</p>
                                    </div>
                                )}
